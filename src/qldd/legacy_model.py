"""LEGACY architecture (pre-SDPA, sigma-based attention) -- kept verbatim so
the Stage-1 d=3 checkpoint (runs/stage1_global/ckpt.pt, tag stage1-go) stays
loadable for inference. Do not use for new training.

Original header: Local diffusion decoder: 3D-conv stem (arXiv:2604.08358) + local-attention
